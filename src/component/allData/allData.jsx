            ...
            <div key={item?._id} className="mapCont">
                ...
                {item?.budget.reverse().map(budget=>(
                    ...
                    {/* <section style={{display:"flex", justifyContent:"space-between"}}> */}
                        ...
                        <div className="budgetItem" style={{fontSize:"14px", textTransform:"uppercase", color:"black", fontWeight:"650"}}>{budget.expenseList[0].purpose.slice(0,8)}{check(budget.expenseList[0].purpose)}</div>
                        <div className="budgetItem" style={{textAlign:"start",fontSize:"14px", fontStyle:"italic"}}>{budget.expenseList[0].detail.slice(0,8)}{check(budget.expenseList[0].detail)}</div>
